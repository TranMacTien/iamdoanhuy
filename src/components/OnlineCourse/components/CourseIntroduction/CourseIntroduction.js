...
import { Center } from "components/Common.styled"
    ...
    <Styled.Section>
      <Styled.GroupFirst>
        ...
        <Styled.Desc>
          ...
          chính là không có một lộ trình học rõ ràng, lan man khiến những người
          học cảm thấy Photoshop vô cùng phức tạp, đặc biệt là người mới.
        </Styled.Desc>
        <Styled.Desc>
          Khoá học này chúng ta sẽ cùng chinh phục những công cụ cần thiết nhất
          của Photoshop, ứng dụng thực hành từng công cụ và mục tiêu kết thúc
          khoá học các bạn sẽ tạo ra được POSTER cho riêng mình.
        </Styled.Desc>
        <Center>
      ...
      <Styled.GroupSecond>
        ...
        <Styled.List>
          ...
          <li>
            Sinh viên các ngành marketing, báo chí, ... nâng cao sự hiểu biết về
            Photoshop để phục vụ công việc khi ra trường.
          </li>
          <li>
      ...
      <Styled.GroupThird>
        ...
        <Styled.Desc>
          Với kinh nghiệm giảng dạy môn Photoshop và làm việc trong ngành thiết
          kế, ở khoá học này, Huy chắt lọc mọi thứ từ kiến thức đến thực hành
          một cách ngắn gọn, dễ hiểu nhất để các bạn có thể học và làm một cách
          dễ dàng.
        </Styled.Desc>
        <Styled.Desc>
          Ở đây Huy không chỉ là bán một khoá học, mà Huy muốn giúp tất cả các
          bạn có thể làm được với Photoshop. Ngoài 30+ video, các bạn sẽ được hỗ
          trợ trực tuyến khi gặp khó khăn trong quá trình học. Huy và team luôn
